...
b1 = xygraph(b1_1, b1_3, b1_2, b1_2, b1_4, b1_4, color=GRAY, lineVisible=0, symbolVisible=1, symbolShape=SymbolShape.FTRIANGLE, symbolColor=RED)
...
bg1 = xygraph(bg1_1, bg1_3, bg1_2, bg1_2, bg1_4, bg1_4, color=GRAY, lineVisible=0, symbolVisible=1, symbolShape=SymbolShape.FCIRCLE, symbolSize=6, symbolColor=RED)
...
b0 = xygraph(b0_1, b0_3, b0_2, b0_2, b0_4, b0_4, color=GRAY, lineVisible=0, symbolVisible=1, symbolShape=SymbolShape.TRIANGLE, symbolColor=DARK_GRAY)
...
bg0 = xygraph(bg0_1, bg0_3, bg0_2, bg0_2, bg0_4, bg0_4, color=GRAY, lineVisible=0, symbolVisible=1, symbolShape=SymbolShape.CIRCLE, symbolSize=6, symbolColor=DARK_GRAY)
