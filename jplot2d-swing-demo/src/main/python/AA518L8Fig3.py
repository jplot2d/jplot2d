...
# Axes
xaxis = axis(type = TransformType.LOGARITHMIC, range=(5e13, 2.5e17))
xaxis.title.text = "r (cm)"
xaxis.title.fontScale = 1
xaxisTop = axis(position = AxisPosition.POSITIVE_SIDE, type=TransformType.LOGARITHMIC, range=(2.8e-2, 2e2), labelFormat="%.0m")
