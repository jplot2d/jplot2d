...
public interface InteractiveComp {
     ...
     */
    void drawLine(Object g, int rgb, int x1, int y1, int x2, int y2);
     ...
     */
    void drawRectangle(Object g, int rgb, int x, int y, int width, int height);
     ...
     */
    void drawShape(Object g, int rgb, Shape shape);
     ...
     */
    void drawTooltip(Object g, String s, int x, int y);

    enum CursorStyle {
        DEFAULT_CURSOR, CROSSHAIR_CURSOR, OPEN_HAND_CURSOR, CLOSE_HAND_CURSOR,
    }
