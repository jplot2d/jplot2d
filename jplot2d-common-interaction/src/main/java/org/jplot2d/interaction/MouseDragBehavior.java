...
/**
 * A behavior triggered by mouse dragging. The MouseButtonCombination for this behavior:
 * <ul>
...
public abstract class MouseDragBehavior extends MouseBehavior {
    ...
    /**
     * If <code>true</code>, the interaction manager will send mouse move events to handler of this behavior.
     */
