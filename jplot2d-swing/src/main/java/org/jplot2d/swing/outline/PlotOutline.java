...
/**
 * The PlotOutlineManager manage a plot tree. It register itself to environment as an ElementChangeListener.
 * Whenever a plot property changed, this PlotOutline will notify the registered ShowPropertiesAction to refresh its contents.
 * Also when user choose a new tree node, this PlotOutline will notify the registered ShowPropertiesAction to show the properties.
 *
 * @author Jingjing Li
 */
public class PlotOutline implements ElementChangeListener {
    ...
    public PlotOutline(PlotEnvironment env) {
        _treeModel = new PlotTreeModel(env.getPlot());
