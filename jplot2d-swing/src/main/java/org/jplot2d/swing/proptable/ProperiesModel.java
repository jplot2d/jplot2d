...
public class ProperiesModel implements Iterable<PropertyGroup> {
	...
	protected ArrayList<PropertyGroup> groups = new ArrayList<PropertyGroup>();

	protected final Map<String, MainProperty<?>> propMap = new HashMap<String, MainProperty<?>>();

	public ProperiesModel(Map<String, PropertyInfo[]> pisGroupMap) {
