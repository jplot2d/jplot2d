...
public class JPlot2DComponent extends JComponent implements HierarchyListener, RenderingFinishedListener {
    ...
    static final Logger logger = LoggerFactory.getLogger("org.jplot2d.swing");
    ...
    private final Object fsnLock = new Object();
    ...
    public JPlot2DComponent(Plot plot, boolean threadSafe) {
        this(new RenderEnvironment(threadSafe));
     ...
     *
     * @return the RenderEnvironment of this JPlot2DComponent
     */
     ...
     *
     * @param bgColor the new background color of plot
     */
     ...
     *
     * @param rendererFactory the new renderer factory
     */
     ...
     *
     * @return the created image renderer
     */
