...
public class TimeHmsTickCalculatorTest {
	...
	private static TimeHmsTickCalculator hmsTC = TimeHmsTickAlgorithm
	...
	public void testCalcValuesByTickNumber() {
		...
		hmsTC.setRange(0, 1);
		hmsTC.calcValuesByTickNumber(11, TickCalculator.AUTO_MINORTICK_NUMBER);
	...
	public void testCalcValuesByInterval() {
		...
		hmsTC.setRange(0, 1);
		hmsTC.calcValuesByTickInterval(0.1, 0,
		...
		hmsTC.setRange(0, 60);
		hmsTC.calcValuesByTickInterval(5, 0,
				TickCalculator.AUTO_MINORTICK_NUMBER);
		assertEquals(hmsTC.getMinorNumber(), 4);
		checkDoubleArray(hmsTC.getValues(), 0, 5, 10, 15, 20, 25, 30, 35, 40,
				45, 50, 55, 60);
		...
		hmsTC.setRange(0, 3600);
		hmsTC.calcValuesByTickInterval(300, 0,
				TickCalculator.AUTO_MINORTICK_NUMBER);
		assertEquals(hmsTC.getMinorNumber(), 4);
		checkDoubleArray(hmsTC.getValues(), 0, 300, 600, 900, 1200, 1500, 1800,
				2100, 2400, 2700, 3000, 3300, 3600);
		...
		hmsTC.setRange(0, 24 * 3600);
		hmsTC.calcValuesByTickInterval(7200, 0,
				TickCalculator.AUTO_MINORTICK_NUMBER);
		assertEquals(hmsTC.getMinorNumber(), 1);
		checkDoubleArray(hmsTC.getValues(), 0, 2 * 3600, 4 * 3600, 6 * 3600,
				8 * 3600, 10 * 3600, 12 * 3600, 14 * 3600, 16 * 3600,
