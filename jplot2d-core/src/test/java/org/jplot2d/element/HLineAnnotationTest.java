...
public class HLineAnnotationTest {
	...
	public void testInterfaceInfo() {
		...
		checkPropertyInfoNames(iinfo.getPropertyInfoGroupMap().get("Horizontal Line Annotation"), "value", "stroke");
		...
		checkPropertyInfoNames(iinfo.getProfilePropertyInfoGroupMap().get("Horizontal Line Annotation"), "stroke");
	}
