...
public class TAIMicrosTickCalculatorTest {
    ...
    public void testDateTicks() {
        ...
        taiTC.calcValuesByTickNumber(11, TickCalculator.AUTO_MINOR_TICK_NUMBER);
        ...
        assertEquals(taiTC.getLabelFormat(), "%tT.%<tN");
        ...
        assertEquals(taiTC.getLabelFormat(), "%tT.%<tL");
        ...
        assertEquals(taiTC.getMinorNumber(), 4);
        assertEquals(taiTC.getLabelFormat(), "%tT");
        ...
        assertEquals(taiTC.getMinorNumber(), 4);
        assertEquals(taiTC.getLabelFormat(), "%tR");
        ...
        assertEquals(taiTC.getLabelFormat(), "%tF %<tR");
        ...
        assertEquals(taiTC.getLabelFormat(), "%tF");
