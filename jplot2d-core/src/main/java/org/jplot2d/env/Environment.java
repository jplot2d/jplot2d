...
/**
 * An environment that a plot can be realized. Once a plot is put an environment,
 * changes on the plot can trigger re-layout or redraw, according to the changed property.
 * <p/>
