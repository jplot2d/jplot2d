...
public interface AxisTickManager extends Element {
	...
	/**
	 * Returns the AxisTickTransform, which defines The relationship between user value and tick
	 * value.
	 * 
	 ...
	 * The AuxTransform <em>must</em> be efficient immutable.
	 * 
	 * @param transform
	 ...
	 * the tick interval is assigned by {@link #setTickInterval(double)}
	 * 
	 ...
	 * multiplying factor between two ticks.
	 * 
	...
	/**
	 * Returns <code>true</code> if labels format is auto calculated or assigned by
	...
	/**
	 * Sets <code>true</code> to auto calculate proper labels format. Or sets <code>false</code> to
	 * assign a label format by {@link #setLabelFormat(String)}
	 * 
	 * @param alf
	 *            the flag
	 */
	...
	/**
	 * Sets the printf-style format that is used to format the tick labels from tick values. The
	 * syntax of format string is described in {@link java.util.Formatter}. Beside the standard Java
	...
	/**
	 * Returns the user assigned substitute labels. <code>null</code> has a special meaning of
	 * "undecided".
	 * 
	...
	/**
	 * Set an array of String to substitute the labels of the fixed ticks. If the length of the
	 * array is shorter then the number of fixed ticks, only the first ticks are changed, if the
	 * length of the array is longer then the number of ticks only the first labels are used. null
	 * in the array means not substitute the label. The given labels can be null or a empty array.
	 * <p>
