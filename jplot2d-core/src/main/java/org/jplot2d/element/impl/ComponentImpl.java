...
public abstract class ComponentImpl extends ElementImpl implements ComponentEx {
    ...
    protected final PropertyChangeSupport _changes = new PropertyChangeSupport(this);
    ...
    /**
     * Mark redraw flag on cacheable parent and re-render flag on root plot
     * when the given component is added, or to be removed. All sub-components are marked cascadedly.
     *
     * @param comp the component to be added, or to be removed.
     */
     ...
     *
     * @param comp the component changed
     */
