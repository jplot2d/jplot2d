...
public class XYGraphImpl extends GraphImpl implements XYGraphEx {
    ...
    private static final Paint DEFAULT_FILL_PAINT = new Color(192, 192, 192, 128);
    ...
    private void fillLineArea(Graphics2D g) {
     ...
     * @param x     the point x
     * @param y     the point y
     * @param low   the low x of the errorbar
     * @param high  the high x of the errorbar
     ...
     * @param x     the point x
     * @param y     the point y
     * @param low   the low y of the errorbar
     * @param high  the high y of the errorbar
     * @param scale the scale
     */
