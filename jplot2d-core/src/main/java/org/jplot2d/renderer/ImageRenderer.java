 ...
 * </ol>
 * A renderer maintains a cache for all cacheable components. The cache is a map, the key is uid of components,
 * the value is components future. The environment must offer those values when calling a renderer
 * <ol>
...
public abstract class ImageRenderer extends Renderer {
    ...
    private static class CompRenderCallable implements Callable<BufferedImage> {
        ...
        /**
         * @param cacheableBlock the CacheableBlock to be rendered
         * @param imageFactory   the image factory
         * @param bounds         the bounds that the rendered image appears
         */
     ...
     *
     * @param sn  the result sn
     * @param img the generated BufferedImage
     */
     ...
     *
     * @param bounds the bounds to limit the components
     * @param cb     a CacheableBlock
     ...
     *
     * @param executor       a executor to render cacheable blocks
     * @param cacheBlockList cacheable blocks to be rendered in executor
     ...
     *
     * @param comp   the cacheable component
     * @param future the future
     * @return <code>true</code> if the future for given component is cached
     */
    ...
    /**
     * Assemble the rendered components given in the AssemblyInfo into a result.
     *
     * @param sn     the result sn
     * @param bounds the result size
     * @param ainfo  the AssemblyInfo
