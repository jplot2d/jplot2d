...
/**
 * This renderer render image when render method called. And the getImage() will
 * wait until the rendering is complete.
 * 
 * @author Jingjing Li
 * 
 */
public class ImageSyncRenderer extends SyncRenderer<BufferedImage> {
	 ...
	 * @param bgColor
	 */
	public ImageSyncRenderer(int imageType, Color bgColor) {
