...
/**
 * Warp a band of image data. The data can be in a array, a 2d array , or a nio Buffer.
 * The ImageDataBuffer can optionally take an offset, so that data in an existing array can be used
 * even if the interesting data doesn't start at array location zero.
 * It can also associate with an ImageMaskBuffer, to determines whether a element is valid or not.
 *
 * @author Jingjing Li
 */
public abstract class ImageDataBuffer {
     ...
     * For double and float data, NaN, POSITIVE_INFINITY and NEGATIVE_INFINITY are considered as invalid.
     *
     * @param w the width of the given rectangle
     * @param h the height of the given rectangle
