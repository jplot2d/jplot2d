...
public class BoundsConstraint {
     ...
     */
    public BoundsConstraint(double elasticTop, double elasticLeft, double elasticBottom, double elasticRight) {
        this(ZERO_INSETS, new Insets2D.Double(elasticTop, elasticLeft, elasticBottom, elasticRight));
    }
