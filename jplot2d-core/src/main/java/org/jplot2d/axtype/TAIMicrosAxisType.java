...
public class TAIMicrosAxisType extends AxisType {
    ...
    /**
     * Returns a TAIMicrosAxisType with default zone and local.
     *
     * @return a TAIMicrosAxisType with default zone and local
     */
    ...
    /**
     * Returns a TAIMicrosAxisType with UTC zone and US local.
     *
     * @return a TAIMicrosAxisType with UTC zone and US local
     */
